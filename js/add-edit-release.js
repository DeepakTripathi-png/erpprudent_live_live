$(document).ready(function () {
	...
	var download_title = "BOM Release Item List";
	var recordsPerPage = 10;
	var BoqItemdataTable = $("#pbomreleaselist").DataTable({
		dom: "Bfrtip",
		scrollY: 400,
		scrollX: true,
		scroller: true,
		...
		ajax: {
			url: base_url + "project_bom_boq_release_item_list?project_id="+ $("#project_id").val(),
			type: "GET",
			// data: {
	...
	$(document).on("change", "#project_id", function () {
		...
		if (project_id) {
			var url = base_url + "project_bom_boq_release_item_list";
