                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <label class="control-label">Vendor Cetgory <span class="require" aria-required="true" style="color:red">*</span></label>

                              <div class="input-icon right">

                                <select class="form-control select2" name="category_id[]" required id="category_id" multiple>
                                  <option value="">Select</option>

                                <?php
                                $selected_categories = explode(',', $vendor_data->category_id);
