                                            ...
                                            {?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; vertical-align: middle;">
                                                        ...
                                                        <a href="<?php echo base_url(); ?>write_off_back?vid=<?php echo base64_encode((isset($key->vendor_id) && !empty($key->vendor_id))?$key->vendor_id:'');?>" class="tooltips " title="Write Off / back"><img src="uploads/images/write_off.png" width="20px" height="20px"></a>
