...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
                                      ...
                                      <table width="100%" id="pboqlist" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									...
            									<th scope="col" style="vertical-align: top;font-size:11px;">BOQ<br>Sr No</th>
    ...
    <script src="<?php echo base_url();?>js/boq-items.js?<?php echo date('Ymd H:i:s'); ?>" type="text/javascript"></script>
    <script>
