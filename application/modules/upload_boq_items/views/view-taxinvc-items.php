 <div id="TaxInvoiceItemList">
    ...
    <input type="hidden" id="tax_invc_no" value="<?php echo $tax_invc_no; ?>">
        ...
        <tbody></tbody>
         <tfoot class="taxinvoicefooter" style="display:none;">
            ...
            <tr style="text-align:right;font-weight:600;">
                ...
                <td></td>
                <td></td>
                <td class="text-right">Additial Amount</td>
            ...
            <tr style="text-align:right;font-weight:600;">
                ...
                <td></td>
                <td></td>
                <td class="text-right">Final Total Amount</td>
...
<script>
    ...
    var tax_invc_no = $('#tax_invc_no').val().trim(); 
    var recordsPerPage = 10; 

    var download_title = tax_invc_no+' Tax Invoice BOQ Item';
