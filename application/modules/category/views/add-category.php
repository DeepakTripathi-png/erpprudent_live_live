...
<head>
    <meta charset="utf-8"/>
    <title>category Master | <?php echo project_name; ?> </title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> category Master</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form action="save_category" enctype="multipart/form-data" id="save_category" method="post" class="horizontal-form">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                            <i class="fa"></i>
                                                            <input type="text" class="form-control duplicate" name="category_name"  id="category_id" data-tbl="tbl_category" data-p_key="category_id" data-where="category_name" rel="0" value="<?php echo(isset($category_data->category_name) && !empty($category_data->category_name))?$category_data->category_name:''?>" placeholder="category name">
                                                        </div>
                                                    </div>
                                                </div>
