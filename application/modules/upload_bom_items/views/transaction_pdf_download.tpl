   ...
   <tr style="padding: 0px; ">
      <td colspan="6" style="font-weight: bold; font-size: 12px; text-align: center; border-bottom: 1px solid gray;">
        <span >Transaction</span>
   	  ...
   	  <tr >
         <td colspan="3" style="font-size: 10px;border-bottom:1px solid gray;" >
         	<span style="font-weight: bold;font-size: 10px; ">Name :- </span>
         	<span style="font-size: 10px;"><?php echo $data['fullname']; ?></span>
         </td>
         <td colspan="3" style="font-size: 10px;border-bottom:1px solid gray;"><span style="font-weight: bold;">Date :-  </span><span style="font-size: 10px;"><?php echo date('Y-m-d', strtotime($data['created_on'])); ?>         </span></td>
...
<table style="border:1px solid gray;" cellpadding="5">
   <tbody>
      <tr style="border:1px solid gray;">
         ...
         <th style="border:1px solid gray;background-color: #b6e8f3;font-weight: bold" >Date</th>
         ...
         <?php if($data['voucher_type'] == 'Project Expense'){ ?>
            ...
            <th style="border:1px solid gray;background-color: #b6e8f3;font-weight: bold" >Decription</th>
      ...
      <tr>
         ...
         <td style="border:1px solid gray;" ><?php echo $data['transaction_date']; ?></td>
