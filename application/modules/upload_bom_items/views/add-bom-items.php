...
<head>
    <meta charset="utf-8"/>
    <title>Add BOM Items | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> Add / Edit BOM Items</span>
                                    </div>
                                </div>
                                                        ...
                                                        <table width="100%" id="bomitmdisplay" class="table table-striped table-bordered table-hover">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control invaliderrorexcept js-bom-add" id="bom_item_make" placeholder="Make" style="font-size: 12px;">
                                                                    </td>

                                                                    <td>
                                                                        <input type="text" class="form-control invaliderrorexcept js-bom-add" id="bom_item_model" placeholder="Model" style="font-size: 12px;">
                                                                    </td>
    ...
    <script src="<?php echo base_url();?>js/bom-items.js?<?php echo date('Ymd H:i:s'); ?>" type="text/javascript"></script>
    <script>
