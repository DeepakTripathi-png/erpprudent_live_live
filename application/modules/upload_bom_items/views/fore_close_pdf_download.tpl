...
<table   style="border:1px solid gray;padding: 15px 15px 15px 8px; ">
   ...
   <tr style="padding: 0px; ">
      <td colspan="6" style="font-weight: bold; font-size: 12px; text-align: center; border-bottom: 1px solid gray;">
        ...
        <td colspan="2"  style="font-size: 10px;border-bottom:1px solid gray;"><span style="font-weight: bold;font-size: 10px;">Fore Close No.</span><br>
         <span style="font-size: 10px;"><?php echo $bom_data[0]['fore_close_number']; ?></span></td>
         <td colspan="2" style="font-size: 10px;border-bottom:1px solid gray;"><span style="font-weight: bold;">Date </span><br><span style="font-size: 10px;"><?php echo $bom_data[0]['fc_date']; ?></span></td>
...
<table style="border:1px solid gray;" cellpadding="5">
   <tbody>
      <tr style="border:1px solid gray;">
         ...
         <th style="border:1px solid gray;background-color: #b6e8f3;font-weight: bold" width="7%">Fc Qty</th>
      ...
      <tr>
         ...
         <td style="border:1px solid gray;" width="7%" ><?php echo number_format($val['fore_close_qty'],2); ?></td>
         <td style="border:1px solid gray;" width="10%"><?php echo number_format($val['veriable_rate'],2); ?></td>
