...
<head>
  <meta charset="utf-8"/>
  <title> Purchase Performa Invoice | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> View Purchase Performa Invoice</span>
                  </div>
                </div>
                <div class="portlet-body">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <input type="hidden" id="ppi" value="">
                        <input type="hidden" id="ppi_count" value="">
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view_vendor_proforma_invoice/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Purchase Proforma Invoice</a>
    ...
    var page_type = 'vendor_proforma_invoice_listing';
  </script>
    <script>
