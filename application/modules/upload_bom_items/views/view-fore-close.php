...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> Fore Close</span>
                  </div>
                </div>
                <div class="portlet-body">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <input type="hidden" id="po_data" value="">
                        <input type="hidden" id="po_count" value="">
                        <a role="presentation" href="<?php echo base_url(); ?>view-bom/<?php echo $project_id_encode; ?>" class="cm menu-item">BOM View</a>
                        <a role="presentation" href="<?php echo base_url(); ?>view-bom-release-quantity/<?php echo $project_id_encode; ?>" class="cm menu-item">Release Quantity</a>
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view_vendor_proforma_invoice/<?php echo $project_id_encode; ?>" class="cm menu-item ">Vendor Proforma Invoice</a>
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view-fore-close/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Fore Close</a>  
    ...
    var page_type = 'fore_close_listing';
  </script>
    <script>
