...
<head>
    <meta charset="utf-8"/>
    <title>Export BOQ Items | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
                ...
                <div class="portlet-body">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> Export BOQ Items</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form action="#" enctype="multipart/form-data" id="exportboq"  method="post" class="horizontal-form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
            										<div class="form-groupp">
            											...
            											<select class="form-control type" id="type" aria-label="Default select example">
                                                            <option value="1" selected>BOM Items</option>
                                                            <option value="2">BOQ Mapping</option>
                                                        </select>
            									    </div>
            									</div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label" style="opacity:0;">Select Project <span class="required" aria-required="true" style="color:#a94442">*</span></label>
                                                        <button type="button" class="btn green" id="exportButton" style="display: block;" title="click To Save" rel="0"><i class="fa fa-upload"></i> Export BOQ Item</button>
                                                    </div>
                    ...
                    <div class="col-md-12" style="display:none;">
                            <div class="portlet light">
                                ...
                                <div class="portlet-body form" id="clientboqlistshowbom">
                                    <table width="100%" id="pboqlist" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									<th scope="col" style="vertical-align: top;">BOQ SR no</th>
            									...
            									<!-- <th scope="col" style="vertical-align: top;">Sch.<br>Qty</th>
            									<th scope="col" style="vertical-align: top;">Ori.Dsgn.<br>Qty</th>
            									<th scope="col" style="vertical-align: top;">Build<br>Qty</th>
            									<th scope="col" style="vertical-align: top;">Rate Basic</th>
            									<th scope="col" style="vertical-align: top;">GST(%)</th>
            									<th scope="col" style="vertical-align: top;">NS/Sch</th>
                        ...
                        <div class="col-md-12" style="display:none;">
                            <div class="portlet light">
                                ...
                                <div class="portlet-body" id="clientboqlistshow">
                                    <table width="100%" id="clientboqlist" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col" style="vertical-align: top;">Sr.no</th>
                                                <th scope="col" style="vertical-align: top;">BOQ<br>Sr No</th>
                                                <th scope="col" style="vertical-align: top;">Client <br> BOQ Sr No </th>
                                                <th scope="col" style="vertical-align: top;">HSN Code</th>
    ...
    <script src="<?php echo base_url();?>js/boq-export.js?<?php echo date('Ymd H:i:s'); ?>" type="text/javascript"></script>
