...
<head>
  ...
  .waiting-approval-tab a {
    padding: 8px 10px!important;
  }
  .waiting-approval-tab li:not(.title-tab):after {
    height: unset;
  }
            ...
            <div class="portlet light">
              ...
              <div class="portlet-body form">
                ...
                <nav id="menu-container" class="arrow">
                  ...
                  <div class="menu-inner-box">
                    <div class="menu" style="text-align:left;">
                      <input type="hidden" name="project_id" id="project_id" value="<?php echo $project_id_encode; ?>">
                      <a role="presentation" href="<?php echo base_url(); ?>view-bom/<?php echo $project_id_encode; ?>" class="cm menu-item">BOM View</a>
                      <a role="presentation" href="<?php echo base_url(); ?>view-bom/<?php echo $project_id_encode; ?>" class="cm menu-item">Release Quantity</a>
                      <a role="presentation" href="<?php echo base_url(); ?>view-bom/<?php echo $project_id_encode; ?>" class="cm menu-item">Indent Request</a>
                      ...
                      <a role="presentation" href="<?php echo base_url(); ?>bom-approval-waiting/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Waiting for Approval</a>
                    </div>
                  </div>
                </nav>
                ...
                <div class="tab-content">
                  ...
                  <!-- <input type="hidden" id="check_permission_status" value="<?php echo $check_permission_status; ?>"> -->
                  <div class="portlet-body form">

                    <!-- <ul class="nav nav-tabs waiting-approval-tab" id="myTab" role="tablist">
                    <li class="nav-item " role="presentation">
                    <a class="nav-link border-0 waiting-approval" data-toggle="tab" data-tab-index="1" href="#boq_waiting">BOQ</a>
                  </li>
                  <li class="nav-item border-0 active" role="presentation">
                  <a class="nav-link waiting-approval"  data-toggle="tab" data-tab-index="2" href="#bom_waiting">BOM</a>
                </li>
              </ul> -->

              <div class="tab-content">
                <div class="tab-pane active" id="bom_waiting" role="tabpanel">
                  <div class="table-responsive-1" style="width:100%;overflow:hidden;">
                    <table width="200%" id="bomtranslist" class="table table-striped table-bordered table-hover">
                      <thead>
                        <tr>
                          <th scope="col" style="width:20px;min-width:20px;vertical-align: top;">Sr.no</th>
                          <!-- <th scope="col" style="width:30px;min-width:30px;vertical-align: top;">BOQ Sr. No.</th> -->
                          <th scope="col" style="width:30px;min-width:30px;vertical-align: top;">BP Code</th>
                          <!-- <th scope="col" style="width:30px;min-width:30px;vertical-align: top;">Item Description</th> -->
                          <th scope="col" style="width:30px;min-width:30px;vertical-align: top;">Event</th>
                          ...
                          <!-- <th scope="col" style="width:30px;min-width:30px;vertical-align: top;">Release Quantity</th> -->
...
<script src="<?php echo base_url();?>js/waiting-for-approval.js?<?php echo date('Y-m-d H:i:s');?>" type="text/javascript"></script>
  <script>
