...
<head>
  <meta charset="utf-8"/>
  <title>Return Memo | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> Return Memo</span>
                  </div>
                </div>
                <div class="portlet-body">
                  ...
                  <table width="100%" id="return_memo_list" class="table table-striped table-bordered table-hover ">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="vertical-align: top;">DC Qty</th>
                        <th scope="col" style="vertical-align: top;">Good Condition</th>
                        <th scope="col" style="vertical-align: top;">Bad Condition</th>
                      ...
                      if (count($data) > 0) {
                        foreach ($data as $key => $value) {  ?>
                          <tr>
                            ...
                            <td><?php echo !empty($value['dc_qty']) ? $value['dc_qty'] : '-' ?></td>
                            <td><?php echo !empty($value['good_condition_qty']) ? $value['good_condition_qty'] : '-' ?></td>
                            <td><?php echo !empty($value['bad_condition_qty']) ? $value['bad_condition_qty'] : '-' ?></td>
    ...
    <script src="<?php echo base_url();?>js/return_memo.js" type="text/javascript"></script>
