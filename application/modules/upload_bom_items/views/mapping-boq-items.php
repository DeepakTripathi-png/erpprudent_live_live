...
<head>
    <meta charset="utf-8"/>
    <title>Mapping BOQ Items | <?php echo project_name; ?> </title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> Mapping BOQ Items</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form action="boq_items_upload" enctype="multipart/form-data" id="boq_items_upload"  method="post" class="horizontal-form">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
            								...
            								<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="mapping_boq_item_excel_file" id="mapping_boq_item_excel_file" class="mapping_boq_item_excel_file">
                                                        <span style="color:#d44;">(Note-Please import only .xls or xlsx Excel File )</span><br>
                                                        <span style="font-size: 14px; text-decoration: underline;"> <a href="<?php echo base_url();?>uploads/sample_excel/mapping_boq_item.xlsx" target="_blank">Download Sample</a></span>
                                                        <br>
                                                    </div>
                                                </div>
                                            </div>
