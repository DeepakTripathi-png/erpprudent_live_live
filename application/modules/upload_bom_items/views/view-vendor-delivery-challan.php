...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <input type="hidden" id="vdc_po" value="">
                        <input type="hidden" id="vdc_po_count" value="">
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view-vendor-delivery-challan/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Vendor Delivery Challan</a>
    ...
    var page_type = 'vendor_delivery_challan_listing';
  </script>
    <script>
