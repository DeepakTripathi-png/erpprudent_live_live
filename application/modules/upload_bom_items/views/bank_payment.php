...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Bank Payment | <?php echo project_name; ?></title>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
                                ...
                                <div class="portlet light">
                                    <div class="portlet-title">
                                        <div class="caption font-blue">
                                            ...
                                            <span class="caption-subject bold uppercase"> Bank Payment</span>
                                        </div>
                                    ...
                                    <table width="100%" id="payout_selection_data" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <!-- <th scope="col" style="vertical-align: top; text-align: center;">Bank</th> -->
                                                <th scope="col" style="vertical-align: top; text-align: center;">Beneficiary Bank</th>
                                                <th scope="col" style="vertical-align: top; text-align: center;">Party Acc. No.</th>
                                                <th scope="col" style="vertical-align: top; text-align: center;">IFSC Code</th>
                                                <th scope="col" style="vertical-align: top; text-align: center;">Branch Name</th>
                                                ...
                                                <th scope="col" style="vertical-align: top; text-align: center;">From Bank Acc No</th>
                                                <th scope="col" style="vertical-align: top; text-align: center;">Payment Date</th>
                                                <th scope="col" style="vertical-align: top; text-align: center;">UTR Number</th>
        ...
        <script src="<?php echo base_url();?>js/bank_payment.js" type="text/javascript"></script>
