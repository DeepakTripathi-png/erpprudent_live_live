...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> View Purchase Order Request</span>
                  </div>
                </div>
                <div class="portlet-body">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view-purchase-order/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Purchase Order</a>
    ...
    var page_type = 'pruchase_order_listing';
  </script>
    <script>
