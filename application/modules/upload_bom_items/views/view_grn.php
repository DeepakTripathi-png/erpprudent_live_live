...
<head>
  <meta charset="utf-8"/>
  <title> GRN | <?php echo project_name; ?> </title>
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> Goods Received Notes</span>
                  </div>
                </div>
                <div class="portlet-body">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <input type="hidden" id="dc_data" value="">
                        <input type="hidden" id="dc_count" value="">
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view-grn/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Goods Received Notes</a>  
                  ...
                  <table width="100%" id="grn_list" class="table table-striped table-bordered table-hover">
                              <thead>
                                 <tr>
                                    ...
                                    <!--<th scope="col" style="vertical-align: top;">DC Qty (In Good -->
                                    <!--Condition)</th>-->
