              ...
              <div class="portlet light">
                ...
                <div class="portlet-body">
                  ...
                  <nav id="menu-container" class="arrow">
                    ...
                    <div class="menu-inner-box">
                      <div class="menu" style="text-align:left;">
                        ...
                        <a role="presentation" href="<?php echo base_url(); ?>view_ppi_payment_receipt/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active">Payment Receipt</a>
                  ...
                  <table width="100%" id="payment_receipt_list" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php foreach ($payment_receipt_data as $key => $value) {  ?>
                          <tr>
