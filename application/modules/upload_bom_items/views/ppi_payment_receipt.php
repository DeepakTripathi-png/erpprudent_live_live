              ...
              <div class="portlet light">
                ...
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> Payment Voucher</span>
                  </div>
                </div>
                <div class="portlet-body">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="vertical-align: top;">PR Amount</th>
                         <th scope="col" style="vertical-align: top;">Payment Mode</th>
                    ...
                    <tbody>
                      ...
                      foreach ($payment_receipt_data as $key => $value) {  ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php
                            if (!empty($value['total_amount_with_deduction'])) {
                              echo number_format($value['total_amount_with_deduction'], 2);
                            } else {
                              echo '-';
                            }
                            ?>
                          ...
                          <td>
                            <?php 
                                if (!empty($value['payment_mode'])) {
                                    ...
                                    if ($value['payment_mode'] === "PDC") {
                                        echo $value['payment_mode'] . ' (' . $value['pdc_date'].")"; 
                                    } else {
                        ...
                        <a href="javascript:void(0);" title="Download Payment Receipt"
                           data-project_id="<?php echo $value['project_id']; ?>"
                           data-boq_code=""
                           data-type="<?php echo $value['event_type']; ?>"
                           data-status="<?php echo $value['status']; ?>"
                           data-transaction_id="<?php echo $value['transaction_id']; ?>"
                           class="download-pr-excel"
                           style="margin-right: 8px;">
                            <i class="fa fa-download" style="color:#000; font-size:15px;"></i>
                        </a>
                        <?php
                        $open_doc_url = $this->config->item("base_url") . "generate_payment_receipt_pdf?project_id=" . $value['project_id'] . "&type=" . $value['event_type'] . "&status=" . $value['status'] . "&transaction_id=" . $value['transaction_id'];
                        ?>
                        <a class="Invoice"
