...
<head>
  <meta charset="utf-8"/>
  <title> Fore Close | <?php echo project_name; ?> </title>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
  ...
  <div class="page-container">
      ...
      <div class="page-content">
        ...
        <div class="alert-container hide">
          ...
          <div class="row form_data">
                ...
                <input type="hidden" id="po_count" value="<?php echo count($vdc_data);?>">
            <div class="col-md-12">
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    <i class="fa fa-plus-circle font-blue"></i>
                    <span class="caption-subject bold uppercase">Fore Close</span>
                  </div>
                </div>
                  ...
                  <form action="javascript:void(0)" enctype="multipart/form-data" id="edit_force_close_form"  method="post" class="horizontal-form">
                    ...
                    <div class="form-body">
                      <div class="row">
                        ...
                        <div class="col-md-4 ">
                          <div class="form-group">
                            <label class="control-label">Vendor Delivery Number </label>
                            <input type="text" class="form-control " id="edit_vdc_number" name="vdc_number" readonly>
                          </div>
                        </div>
                      ...
                      <div class="col-md-3" >
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end right" style="position: relative !important;top: 20px !important;left: 230% !important;">
                          ...
                          <button type="submit" class="btn green common_save" title="Click To Save" rel="0">
                            <i class="fa fa-dot-circle-o"></i> Fore Close
                          </button>
                        </div>
                      </div>
                    </div>
                ...
                <div class="portlet-body form add_po_form">
                  <form action="javascript:void(0)" enctype="multipart/form-data" id="force_close_form"  method="post" class="horizontal-form">
                    ...
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <input type="hidden" class="form-control"  name="project_id" readonly value="<?php echo $common_data['project_id']; ?>">
                            <span id="projlaoding"></span>
                          </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <!--<div class="col-md-4 vendor-details">-->
                        <!--  <div class="form-group">-->
                        <!--    <label class="control-label">VDC Number </label>-->
                        <!--    <input type="text" class="form-control " id="vdc_number" name="vdc_number" value="<?php echo $vdc_info[0]['dc_number'];?>"  readonly>-->
                        <!--  </div>-->
                        <!--</div> -->
                        <div class="col-md-4">
                          <div class="form-group">
                            <label class="control-label">VDC Number </label>
                            <select class="form-select form-control" aria-label="Default select example" id="vdc_number" name="vdc_number">
                            <option value="">Select VDC Number</option>
                            <?php foreach ($vdc_info as $item){ ?>
                                <option value="<?php echo $item['dc_number']; ?>">
                                    <?php echo $item['dc_number']; ?>
                                </option>
                            <?php }; ?>
                        </select>
                            <!-- <input type="text" class="form-control "  value="<?php echo $common_data['po_number'];?>"  readonly> -->
                          </div>
                        </div>
                      ...
                      <div id="displayPOItems" style="width: 100%;overflow-x: auto;">
                        <table width="100%" id="bomindentitmdisplay" class="table table-striped table-bordered table-hover hide" style="margin-top:15px;">
                        <thead>
                                       <tr>
                                          <th style="min-width: 4%;width:4%;">Sr. No.</th>
                                          <th style="min-width: 5%;width:5%;">BOM Sr. No.</th>
                                          <th style="min-width: 15%;width:15%;">Item Description</th>
                                          <th style="min-width: 5%;width:5%;">Unit</th>
                                          <th style="min-width: 10%;width:10%;">Make</th>
                                          <th style="min-width: 10%;width:10%;">Model</th>
                                          <th style="min-width: 7%;width:7%;">Po Qty</th>
                                          <th style="min-width: 7%;width:7%;">Delivered<br> Qty</th>
                                          <th style="min-width: 7%;width:7%;">Fore Close <br> Qty</th>
                                          <th style="min-width: 7%;width:7%;">Basic Rate</th>
                                          <th style="min-width: 5%;width:5%;">GST</th>
                                          <th style="min-width: 10%;width:10%;">Amount</th>
                                          <th style="min-width: 5%;width:5%;">Action</th>
                                       </tr>
                                    </thead>
                                    <tbody >
                                    <?php 
                                      ...
                                      if (!empty($vdc_data)) {
                                        ...
                                        foreach ($vdc_data as $key => $data) {
                                          // if ($po_number_item_arr[$data['bom_code']] > 0) {
                                            ...
                                            $qty = $data['po_quantity'] - $data['good_condition_qty']; 
                                            $gst_percentage = $data['gst'];
                                            $gst_amount = ($qty * $basic_rate * $gst_percentage) / 100; 
                                            $total_amount = ($qty * $basic_rate) + $gst_amount; 
                                            ?>
                                            <tr>
                                              <td><input type="text" class="form-control" name="sr_no[]" value="<?= ($key + 1) ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="bom_code[]" value="<?= $data['bom_code'] ?>" readonly></td>
                                              <td>
                                                <input type="text" class="form-control" name="bom_item_description[]" value="<?= $data['item_description'] ?>" readonly>
                                                <input type="hidden" class="form-control" name="hsn_sac_code[]" value="<?= $data['hsn_code'] ?>" readonly>
                                              </td>
                                              <td><input type="text" class="form-control" name="bom_unit[]" value="<?= $data['unit'] ?>" readonly></td>
                                              <!-- <td><select class="form-control" name="bom_make[]"><option><?= $data['make'] ?></option></select></td>
                                              <td><select class="form-control" name="bom_model[]"><option><?= $data['model'] ?></option></select></td> -->
                                              
                                              <td><input type="text" class="form-control" name="bom_make[]" value="<?= $data['make'] ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="bom_model[]" value="<?= $data['model'] ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="bom_po_stock[]" value="<?= $data['po_quantity'] ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="bom_dc_stock[]" value="<?= $data['good_condition_qty'] ?>" readonly></td>
                                              <td><input type="text" class="form-control onlyNumericInput" name="bom_fore_close[]" value="<?= ($data['po_quantity'] - $data['good_condition_qty']) ?>" data-max="<?= ($data['po_quantity'] - $data['good_condition_qty']) ?>"></td>
                                              <!-- <td><input type="text" class="form-control" name="bom_fore_close[]" value="<?= $qty ?>" data-max="<?= $qty ?>"></td> -->
                                              <td><input type="text" class="form-control js-po-basic_rate" name="basic_rate[]" value="<?= $basic_rate ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="bom_gst[]" value="<?= $gst_percentage ?>" readonly></td>
                                              <td><input type="text" class="form-control" name="amount[]" value="<?= $total_amount ?>" readonly></td>
                                              <td><div class="addDeleteButton"><span class="tooltips deleteParticularRow" style="cursor: pointer;"><i class="fa fa-trash-o"></i></span></div></td>
                                            </tr>
                                            <?php 
                                          // }
                                        }

                                        // If no valid rows exist, show "No data available" row
                                        if (!$dataExists) {
                                          echo '<tr><td colspan="13" style="text-align: center;">No data available</td></tr>';
                                        }
                                      } else {
                                        echo '<tr><td colspan="13" style="text-align: center;">No data available</td></tr>';
                                      }
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="portlet light">
                ...
                <div class="portlet-body">
                  <table width="100%" id="foreCloseList" class="table table-striped table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="vertical-align: top;">Fore Close No.</th>
                        <th scope="col" style="vertical-align: top;">Vendor Name</th>
                        <th scope="col" style="vertical-align: top;">FC Amount</th>
    ...
    <script src="<?php echo base_url();?>js/fore_close.js?" type="text/javascript"></script>
