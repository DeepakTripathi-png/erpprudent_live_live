                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control"  name="dc_amount" id="edit_dc_amount" placeholder="GRN Amount" required readonly >
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
                           ...
                           <form action="javascript:void(0)" enctype="multipart/form-data" id="grn_form" method="post">
                              <div class="row" style="border-bottom:1px solid #c5bcbc7d;">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                       <label class="control-label">GRN Amount <span class="required" aria-required="true" style="color:#a94442">*</span></label>
                                       <input type="text" class="form-control"  name="dc_amount" placeholder="GRN Amount" required readonly value="<?php echo number_format($total_dc_amount,2, '.', ''); ?>">
                                    </div>
                                 </div>
                                 <div class="col-md-3">
                                    <div class="form-group">
