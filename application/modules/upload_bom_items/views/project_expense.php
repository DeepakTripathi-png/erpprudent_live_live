...
<head>
  <meta charset="utf-8"/>
  <title>Project Expense | <?php echo project_name; ?> </title>
              ...
              <div class="portlet light">
                <div class="portlet-title">
                  <div class="caption font-blue">
                    ...
                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> Project Expense</span>
                  </div>
                </div>
                  ...
                  <table width="100%" id="voucher_list" class="table table-striped table-bordered table-hover ">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="vertical-align: top;">Voucher Date</th>
                      ...
                      if (count($data) > 0) {
                        foreach ($data as $key => $value) {  ?>
                          <tr>
                            ...
                            <td><?php echo !empty($value['voucher_type']) ? $value['voucher_type'] : '-' ?></td>
