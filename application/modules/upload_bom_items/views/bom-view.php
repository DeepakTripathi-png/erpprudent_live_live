                        ...
                        <div class="portlet light">
                            ...
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo (isset($bp_code) && !empty($bp_code)) ? '(#' . $bp_code . ')' : '' ?> View BOM</span>
                                </div>
                            </div>
                                ...
                                <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        <div class="menu" style="text-align:left;">
                                            ...
                                            <a role="presentation" href="<?php echo base_url(); ?>view-bom/<?php echo $project_id_encode; ?>" class="cm menu-item menu-item-active boq-view">BOM View</a>
