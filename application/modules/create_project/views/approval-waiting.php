                            ...
                            <div class="portlet-body form">
                                ...
                                <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                        ...
                                        <div class="menu" style="transform: translateX(-90%);">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>approval-waiting/<?php echo base64_encode($project_id); ?>" class="cm menu-item waiting-approval menu-item-active">Waiting for Approval</a>
                                ...
                                <div class="tab-content">
                                    ...
                                    <ul class="nav nav-tabs waiting-approval-tab hide" id="myTab" role="tablist">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane  active" id="boq_waiting" role="tabpanel">
                                        ...
                                        <div class="tab-pane fade" id="bom_waiting" role="tabpanel">
                                            <div class="table-responsive-1" style="width:100%;overflow:hidden;">
