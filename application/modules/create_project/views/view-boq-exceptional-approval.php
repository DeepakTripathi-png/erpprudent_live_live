...
<body class="page-header-fixed page-sidebar-closed-hide-logo">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption font-blue">
                                    ...
                                    <span class="caption-subject bold uppercase"><?php echo(isset($bp_code) && !empty($bp_code))?'(#'.$bp_code.')':''?> BOQ Exceptional Approval</span>
                                </div>
                            ...
                            <nav id="menu-container" class="arrow">
                                    ...
                                    <div class="menu-inner-box">
                                    	...
                                    	<a role="presentation" href="<?php echo base_url(); ?>view-boq-exceptional-approval/<?php echo base64_encode($project_id); ?>" class="cm menu-item menu-item-active view-boq-exceptional-approval">BOQ Exceptional Approval</a>
                                ...
                                <div class="portlet-body form">
                                       <table width="100%" id="boqexceptlist" class="table table-striped table-bordered table-hover">
            							<thead>
            									...
            									<th scope="col" style="min-width:30px;width:30px;vertical-align: top;">Billing Type</th>
    ...
    $('#boqexceptlist').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('get_boq_exceptional_list'); ?>",
            "type": "POST",
