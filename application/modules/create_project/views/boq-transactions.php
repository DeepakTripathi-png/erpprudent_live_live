                                    ...
                                    <table width="100%" id="pboqlist<?php echo $i; ?>" class="table table-striped table-bordered table-hover">
            							<thead>
            								<tr>
            									...
            									<th scope="col" style="min-width:80px;width:80px;vertical-align: top;">BP Code</th>
            								    <th scope="col" style="min-width:30px;width:30px;vertical-align: top;">BOQ <br>Sr No</th>
            								    <th scope="col" style="min-width:450px;width:450px;vertical-align: top;">Item Description</th>
            									...
            									<th scope="col" style="min-width:30px;width:30px;vertical-align: top;">Rate Basic</th>
            									<th scope="col" style="min-width:30px;width:30px;vertical-align: top;">GST %</th>
            									<th scope="col" style="min-width:30px;width:30px;vertical-align: top;">Non<br>Sch.</th>
            								</tr>
            							</thead>
            							<tbody> 
            					    </table>
