                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group date date1" data-date-end-date="0d" data-date-format="dd-mm-yyyy">
                                                                    ...
                                                                    <input type="text" name="po_loi_received_data" id="po_loi_received_data" class="form-control" readonly="" placeholder="Select PO/LOI Received Date" value="<?php echo (isset($project_data->po_loi_received_data) && !empty($project_data->po_loi_received_data)) ? $project_data->po_loi_received_data : '' ?>">
